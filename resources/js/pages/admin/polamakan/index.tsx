                    ...
                    <div className="mx-auto max-w-7xl rounded-lg bg-white p-8 shadow-lg dark:bg-gray-900 dark:text-white">
                        ...
                        <form className="flex flex-col gap-6" onSubmit={submit}>
                            <section className="mb-4">
                                <h2  className="bg-blue-100 text-black p-4 text-left text-lg font-semibold md:text-xl dark:bg-gray-800">
                            ...
                            <section className="mb-4">
                                <h2 className="bg-accent mb-4 border-b pb-2 text-xl font-semibold text-gray-800 dark:text-gray-200">Pola Makan</h2>
                                <div className="mb-2">
                                    <Label htmlFor="rekomendasi">Rekomendasi Makanan</Label>
                                    <div>
                                        <ReactQuill theme="snow" value={data.rekomendasi} onChange={(e) => setData('rekomendasi', e ?? '')} />
                                    </div>
                                </div>
                                <div className="mb-2">
                                    <Label htmlFor="rekomendasi">Catatan Dokter </Label>
                                    <div>
                                        <ReactQuill theme="snow" value={data.catatan_dokter} onChange={(e) => setData('catatan_dokter', e ?? '')} />
                                    </div>
                                </div>
                            </section>
