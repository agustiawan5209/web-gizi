...
export default function PemeriksaanCreate({ breadcrumb, orangtua, pemeriksaan }: PemeriksaanCreaterops) {
    ...
    const { data, setData, get, post, processing, progress, errors, reset } = useForm<Required<CreateForm>>({
        ...
        tempat_lahir: pemeriksaan.tempat_lahir,
        tanggal_lahir: pemeriksaan.tanggal_lahir,
        jenis_kelamin: pemeriksaan.jenis_kelamin,
    });

    /**
     * Handles the form submission. Prevents the default form submission,
     * then makes a POST request to the server to store the new Pemeriksaan.
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('admin.pemeriksaan.update', {pemeriksaan: pemeriksaan.id}), {
