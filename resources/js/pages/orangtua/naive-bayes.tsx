                                                            ...
                                                            {Object.entries(result.calculations).map(([status, calc]) => (
                                                                <tr key={status} className="border-b border-gray-200">
                                                                    ...
                                                                    <td className="px-3 py-2 text-right">
                                                                        {calc.likelihoods['Usia'].toExponential(2)}
                                                                    </td>
                                                                    <td className="px-3 py-2 text-right">
                            ...
                            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow">
                                ...
                                {showTheory && (
                                    <div className="mt-4 space-y-2 text-sm text-gray-700">
                                        ...
                                        <p>
                                            Kita menghitung probabilitas posterior untuk setiap kelas status gizi dan memilih kelas dengan
